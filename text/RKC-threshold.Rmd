...
This method relies on an average survey biomass estimate to establish zones of stock status or health. The long-term averagve biomass would set green, yellow, and red levels that would dictact fishery openings and closures, in addition to aiding in determining the level of caution needed for setting harvest levels (Figures 2 and 3). 
